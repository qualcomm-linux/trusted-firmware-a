...
Trusted Firmware-A (TF-A) implements the EL3 firmware layer for Qualcomm SC7180,
SC7280 and QCS615.
...
Qualcomm SoC expects TF-A's BL31 to get integrated with other boot software
