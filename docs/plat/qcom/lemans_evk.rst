...
Steps to build TF-A BL2 and FIP payload::
	...
	$ make CROSS_COMPILE=aarch64-none-elf- PLAT=lemans_evk SPD=opteed \
        ...
        $ ./tools/qcom/generate_fip_elf.sh build/lemans_evk/release/fip.bin \
            0xaf000000
...
Qualcomm signing involved. Also, the fip.elf generated above is signed using
...
Boot logs on lemans_evk::
        ...
        ERROR:   Please refer docs/plat/qcom/* for more details.
        I/TC:
