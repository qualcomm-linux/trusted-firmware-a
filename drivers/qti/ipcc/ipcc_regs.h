 ...
 *
 * What varies -- where the block sits, the protocol and client page strides, the
 * signal count -- comes from <chipset>/ipcc_hwio.h, pulled in below. The #error
 * guards keep a new target from building with a missing stride.
 */
#include <ipcc_hwio.h>
