...
static struct vmidmt_map g_vmid_map_ipa[] = {
	...
	{ { 7 }, 1, 7, ACC_VMID_IPA_GP,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 8 }, 1, 8, ACC_VMID_NOACCESS,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 9 }, 1, 9, ACC_VMID_IPA_GP,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 10 }, 1, 10, ACC_VMID_NOACCESS,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 11 }, 1, 11, ACC_VMID_NOACCESS,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 12 }, 1, 12, ACC_VMID_NOACCESS,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 13 }, 1, 13, ACC_VMID_NOACCESS,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 14 }, 1, 14, ACC_VMID_NOACCESS,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	...
	{ { 32 }, 1, 32, ACC_VMID_IPA_GP,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 33 }, 1, 33, ACC_VMID_NOACCESS,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 34 }, 1, 34, ACC_VMID_NOACCESS,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 40 }, 1, 40, ACC_VMID_IPA_FW,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 41 }, 1, 41, ACC_VMID_NOACCESS,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 48 }, 1, 48, ACC_VMID_NOACCESS,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
};

/* VMID mappings for HAL_VMIDMT_QUPV3_0. */
static struct vmidmt_map g_vmid_map_qupv3_0[] = {
	{ { 0 }, 1, 0, ACC_VMID_AP,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 1 }, 1, 1, ACC_VMID_AP,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
...
/* VMID mappings for HAL_VMIDMT_QUPV3_1. */
static struct vmidmt_map g_vmid_map_qupv3_1[] = {
	{ { 0 }, 1, 0, ACC_VMID_AP,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
	{ { 1 }, 1, 1, ACC_VMID_AP,
	  ACC_VMIDMT_FLAG_STATIC_CONFIG, ACC_VMIDMT_MEMTYPE_DEFAULT },
...
const struct vmidmt_cfg g_vmidmt_cfg[] = {
	...
	{ NULL, 0, HAL_VMIDMT_QUPV3_0, VMIDMT_ERR_OPT, ACC_VMIDMT_STATIC_CONFIG_TZ,
	  ACC_VMID_NOACCESS, g_vmid_map_qupv3_0, ARRAY_SIZE(g_vmid_map_qupv3_0) },
	{ NULL, 0, HAL_VMIDMT_QUPV3_1, VMIDMT_ERR_OPT, ACC_VMIDMT_STATIC_CONFIG_TZ,
	  ACC_VMID_NOACCESS, g_vmid_map_qupv3_1, ARRAY_SIZE(g_vmid_map_qupv3_1) },
};
...
struct hal_vmidmt_info g_vmidmt_info_cfg[] = {
	{ HAL_VMIDMT_IPA, IPA_0_IPA_VMIDMT_SCR0_ADDR,
	...
	[ACC_VMIDMT_ERR_INT_STATUS_REG_NUM][ACC_VMIDMT_ERR_NUM_PER_REG] = {
		{
			...
			{ 7, HAL_VMIDMT_LPASS_RXTX }, 
			{ 8, HAL_VMIDMT_LPASS_VA }, 
			{ 9, HAL_VMIDMT_IPA },
			{ 10, HAL_VMIDMT_QDSS_VMIDETR },
			{ 11, HAL_VMIDMT_QDSS_VMIDDAP },
			{ 12, HAL_VMIDMT_COUNT }, 
			{ 13, HAL_VMIDMT_QSPI }, 
			{ 14, HAL_VMIDMT_LPASS_WSA }, 
			{ 15, HAL_VMIDMT_COUNT }, 
			{ 16, HAL_VMIDMT_COUNT }, 
			{ 17, HAL_VMIDMT_COUNT }, 
		},
