 ...
 */
CASSERT((int)XPU4_DEVICE_MPU != (int)AC_MPU, assert_device_type_variant_mpu_reversed);
CASSERT((int)XPU4_DEVICE_RPU != (int)AC_RPU, assert_device_type_variant_rpu_reversed);
