...
/*
 * Utility functions common to Qualcomm platforms
 */
...
struct image_info *qcom_get_image_info(unsigned int image_id);
...
const interrupt_prop_t *plat_qcom_get_interrupt_props(unsigned int *num_props);
...
void qcom_pmic_prepare_reset(void);
void qcom_pmic_prepare_shutdown(void);
...
void plat_qcom_bl31_setup_post(void);
