...
/* The Qualcomm power domain tree descriptor */
const unsigned char qcom_power_domain_tree_desc[] = {
...
{
	return qcom_power_domain_tree_desc;
}
...
{
	int core_linear_index = plat_qcom_core_pos_by_mpidr(mpidr);
