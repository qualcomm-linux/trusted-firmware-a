...
PLAT_BL_COMMON_SOURCES	:=	${GICV2_SOURCES}				\
				...
				plat/qcom/bear/msm8916/msm8916_gicv2.c		\
				plat/qcom/bear/msm8916/msm8916_setup.c		\
				plat/qcom/bear/msm8916/${ARCH}/msm8916_helpers.S	\
				plat/qcom/bear/msm8916/${ARCH}/uartdm_console.S
...
MSM8916_PM_SOURCES	:=	drivers/arm/cci/cci.c				\
				...
				plat/qcom/bear/msm8916/msm8916_config.c		\
				plat/qcom/bear/msm8916/msm8916_cpu_boot.c	\
				plat/qcom/bear/msm8916/msm8916_pm.c		\
				plat/qcom/bear/msm8916/msm8916_topology.c

BL31_SOURCES		+=	${MSM8916_PM_SOURCES}				\
				plat/qcom/bear/msm8916/msm8916_bl31_setup.c

PLAT_INCLUDES		:=	-Iplat/qcom/bear/msm8916/include
...
QCOM_UART_NUM			?= 2
$(eval $(call assert_numeric,QCOM_UART_NUM))
$(eval $(call add_define,QCOM_UART_NUM))
...
QCOM_RUNTIME_UART		?= 0
$(eval $(call assert_boolean,QCOM_RUNTIME_UART))
$(eval $(call add_define,QCOM_RUNTIME_UART))
