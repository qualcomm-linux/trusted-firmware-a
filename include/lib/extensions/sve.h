...
void sve_vectors_context_save(simd_regs_t *regs);
void sve_vectors_context_restore(simd_regs_t *regs);
void save_ffr(simd_regs_t *regs);
void restore_ffr(simd_regs_t *regs);
#endif
