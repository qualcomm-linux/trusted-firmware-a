...
/* TOC minor version supported */
#define SMEM_TOC_MINOR_VERSION	0x00000001
...
/* Maximum allowed SMEM Hosts */
#define SMEM_TOC_MAX_SMEM_HOSTS	96
...
/*
 * Structure of entries in DT or DevConfig XML to configure the TOC
 */
struct smem_toc_config {
	uint32_t size;
	uint32_t flags;
	uint32_t host0;
	uint32_t host1;
