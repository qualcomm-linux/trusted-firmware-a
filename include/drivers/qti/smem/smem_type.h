 ...
 * SMEM Host type
 */
typedef uint16_t smem_host_type;
...
#define SMEM_HOST_ID(proc_id, proc_num, pd_num, chiplet)             \
	((smem_host_type)((((proc_id) & SMEM_HOST_ID_PROC_ID_BMSK)   \
...
#define SMEM_PROC_SPSS_SP	11 /* SPSS host shares partition w/ TZ */
...
#define SMEM_NUM_HOSTS	26 /* Max number of host in target */
...
#define SMEM_SPSS_SP                          \
	SMEM_HOST_ID(SMEM_PROC_SPSS_SP, 0, 0, \
		     0) /*< SPSS host that shares partition with TZ */
...
#define SMEM_APPS_VM_LA                          \
	SMEM_HOST_ID(SMEM_PROC_APPS_VM_LA, 0, 0, \
		     0) /*< VM LA Host of Apps processor> */
#define SMEM_EXT_PM	SMEM_HOST_ID(SMEM_PROC_EXT_PM, 0, 0, 0) /*< External PM > */
#define SMEM_GPDSP0 \
	SMEM_HOST_ID(SMEM_PROC_GPDSP, 0, 0, 0) /*< General Purpose DSP 0 > */
#define SMEM_GPDSP1 \
	SMEM_HOST_ID(SMEM_PROC_GPDSP1, 0, 0, 0) /*< General Purpose DSP 1 > */
#define SMEM_SOCCP	SMEM_HOST_ID(SMEM_PROC_SOCCP, 0, 0, 0) /*< SOCCP processor */
#define SMEM_OOBSS \
	SMEM_HOST_ID(SMEM_PROC_OOBSS, 0, 0, 0) /*< OOB Secure processor */
#define SMEM_OOBNS \
	SMEM_HOST_ID(SMEM_PROC_OOBNS, 0, 0, 0) /*< OOB Non Secure processor */
...
#define SMEM_AM \
	SMEM_HOST_ID(SMEM_PROC_AM, 0, 0, 0) /*< Ambient Microcontroller */
#define SMEM_QECP \
	SMEM_HOST_ID(SMEM_PROC_QECP, 0, 0, 0) /*< Ambient Microcontroller */

/* Kept for legacy purposes. New code should use SMEM_ADSP */
#define SMEM_Q6	SMEM_ADSP
/* Kept for legacy purposes. New code should use SMEM_WCN */
#define SMEM_RIVA	SMEM_WCN

/* Multi hosts supported partition */
#define SMEM_MULTI_HOST	((smem_host_type)0xFFFC)
/* Reserved partition for command DB usecase */
#define SMEM_CMDDB	((smem_host_type)0xFFFD)
/* Common host */
#define SMEM_COMMON_HOST	((smem_host_type)0xFFFE)
/* Invalid processor */
#define SMEM_INVALID_HOST	((smem_host_type)0xFFFF)
