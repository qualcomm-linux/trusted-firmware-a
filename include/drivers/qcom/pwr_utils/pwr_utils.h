...
#include <drivers/qcom/pwr_utils/voltage_level.h>
...
/*
 * qcom_pwr_utils_init - set up rails and supported corners for the target.
 *
 * Must be called once during subsystem initialization before any other
 * pwr_utils API is used.
 */
#ifdef QCOM_PWR_UTILS_ENABLED
void qcom_pwr_utils_init(void);
#else
static inline void qcom_pwr_utils_init(void) {}
#endif
